const fullQuestionBank = [
    ...
    // --- PASSIVE VOICE (BỊ ĐỘNG) - TYPE 4: Viết lại câu ---
    ...
    // --- PASSIVE VOICE - TYPE 1: Trắc nghiệm ---
    ...
    // --- ERROR IDENTIFICATION - TYPE 3: Tìm lỗi sai ---
    ...
    // --- PASSIVE VOICE - TYPE 4: Viết lại câu ---
    ...
    // --- CONDITIONALS & WISHES - TYPE 1: Trắc nghiệm ---
    ...
    // --- CONDITIONALS - TYPE 1: Trắc nghiệm ---
    ...
    { id: 124, type: 1, question: "If we had known the way, we _______ lost.", options: ["won't get", "wouldn't get", "wouldn't have got", "did get"], answer: "wouldn't have got" },
    { id: 125, type: 1, question: "If he weren't busy, he _______ us.", options: ["help", "helps", "would help", "will help"], answer: "would help" },

    // --- CONDITIONALS - TYPE 2: Sắp xếp câu ---
    { id: 126, type: 2, question: "Arrange: If / rain / it / will / stay / we / home", answer: "If it rains we will stay home" },
    { id: 127, type: 2, question: "Arrange: had / If / I / time / enough / I / would / travel", answer: "If I had enough time I would travel" },
    { id: 128, type: 2, question: "Arrange: would / you / what / do / were / rich / if / you", answer: "What would you do if you were rich" },
    { id: 129, type: 2, question: "Arrange: wish / I / speak / could / English / well", answer: "I wish I could speak English well" },
    { id: 130, type: 2, question: "Arrange: had / studied / he / passed / if / would / he", answer: "If he had studied he would have passed" },
    ...
    // --- CONDITIONALS - TYPE 2: Sắp xếp câu ---
    { id: 146, type: 2, question: "Arrange: wish / I / not / be / late / today", answer: "I wish I were not late today" },
    { id: 147, type: 2, question: "Arrange: would / have / we / gone / if / known / had / we", answer: "If we had known we would have gone" },
    { id: 148, type: 2, question: "Arrange: if / were / what / you / do / free / you", answer: "What would you do if you were free" },
    { id: 149, type: 2, question: "Arrange: wish / she / not / forget / my / birthday", answer: "She wishes she didn't forget my birthday" },
    { id: 150, type: 2, question: "Arrange: had / saved / if / money / I / bought / would / I / it", answer: "If I had saved money I would have bought it" },

    // --- RELATIVE CLAUSES - TYPE 1: Trắc nghiệm ---
    ...
    // --- ERROR IDENTIFICATION - TYPE 3: Tìm lỗi sai ---
    { id: 161, type: 3, question: "The man *which* lives next door is friendly.", options: ["which", "lives", "next door", "is"], answer: "which" },
    { id: 162, type: 3, question: "The book *who* I borrowed is interesting.", options: ["who", "I", "borrowed", "is"], answer: "who" },
    { id: 163, type: 3, question: "The girl *whose* *she* is singing is my friend.", options: ["whose", "she", "is", "singing"], answer: "she" },
    { id: 164, type: 3, question: "The place *which* we met *there* is beautiful.", options: ["which", "we", "met", "there"], answer: "there" },
    { id: 165, type: 3, question: "The student *who* *study* hard will succeed.", options: ["who", "study", "hard", "will"], answer: "study" },

    // --- REPORTED SPEECH - TYPE 4: Viết lại câu ---
    ...
    // --- REPORTED SPEECH - TYPE 1: Trắc nghiệm ---
    ...
    // --- RELATIVE & REPORTED - TYPE 2: Sắp xếp câu ---
    { id: 181, type: 2, question: "Arrange: boy / who / the / is / playing / my / brother / football", answer: "The boy who is playing football is my brother" },
    { id: 182, type: 2, question: "Arrange: said / he / tired / was / that / he", answer: "He said that he was tired" },
    { id: 183, type: 2, question: "Arrange: girl / whose / doctor / is / mother / the / my / friend / is", answer: "The girl whose mother is a doctor is my friend" },
    { id: 184, type: 2, question: "Arrange: she / said / would / she / come / later / that", answer: "She said that she would come later" },
    { id: 185, type: 2, question: "Arrange: the / which / book / reading / am / I / interesting / is", answer: "The book which I am reading is interesting" },

    // --- RELATIVE & REPORTED - TYPE 1: Trắc nghiệm ---
    ...
    // --- ERROR IDENTIFICATION - TYPE 3: Tìm lỗi sai ---
    { id: 196, type: 3, question: "The boy *who* *she* likes is very kind.", options: ["who", "she", "likes", "is"], answer: "she" },
    { id: 197, type: 3, question: "He said *that* he *will* come later.", options: ["that", "he", "will", "come"], answer: "will" },
    { id: 198, type: 3, question: "The place *where* we met *there* was crowded.", options: ["where", "we", "met", "there"], answer: "there" },
    { id: 199, type: 3, question: "She said she *is* happy *then*.", options: ["she", "is", "happy", "then"], answer: "is" },
    { id: 200, type: 3, question: "The student *which* won the prize is my friend.", options: ["which", "won", "the prize", "is"], answer: "which" }
];
